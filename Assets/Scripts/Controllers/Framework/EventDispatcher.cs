...
namespace Controllers.Framework
{
    public class EventDispatcher : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            {
                // Destroy this instances because already exist the singleton of EventDispatcher
        ...
        /// <summary>
        ///     Post the event. This will notify all listener that register for this event
        /// </summary>
